...
이번 변경은 공통 HWP 추출기다. 엔진6/첨부 프로필17/전용 본문16/형식3의 수를 늘리는 수집처 모델 추가가 아니다. 전체 ATT-001~062 및 Gate0~8의 미완료 범위는 보존한다. 태백 실제 HWP의 9,743자/480블록 부분 추출이 해소됐다는 증거는 아직 없다.
...
- [ ] 새 SHA Linux의 실제 격리/PG 경로 검증.
- [ ] 새 runtime에서 실제 공식 HWP/HWPX 파일의 품질·순서·고정 기대값 재검증.
