...
| 6 자동·실파일 QA | [!] | 174230a Linux 계약/격리/정책 부모 검증 성공, 충주 관측2통과/1실패: 양성1건 BODY·DETAIL 시간 초과/파일·추출0. 앞선 제천 HWPX3개 완전 추출/UNKNOWN, 태백 HWP 부분 추출·HWPX2파일 고정 비교와 구분. 전체 Provider·정상 공고·형식 기대값은 잔여 |
