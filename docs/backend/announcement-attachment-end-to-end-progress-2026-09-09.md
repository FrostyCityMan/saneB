...
| 3 분류·정책 | [~] | 로컬 전용 BODY18. catalog33참조/11기관/보관 기대값1/정상0·coverage false. 남구44381은 추출기1.0.7 COMPLETE_TEXT이나 구간 미확정, 다른2파일은 부분 추출로 검수 유지. 보은 명시 구간1.0.3 실제 저장3건 검증, UNKNOWN3/2/1 유지. 전체 Provider/형식/정상 기대값·현행 지문 QA·정책 게시 미완료 |
...
| 6 자동·실파일 QA | [!] | 전체 격리 QA 승인과 보은 추가30회 적용. 추출기1.0.7/명시 구간1.0.3 보은 worker·임시 DB·버전/판정 결합 GET3건 성공, UNKNOWN3/2/1 유지.614850d Linux36012304604의 root3013 및 별도 suite 실패0 확인. 최신 c477c65 CI는 마지막 조회 실행 중이다. 차단 사유는 QA 승인 대기가 아니라 전체 Provider의 검토된 정상/형식 기대값 및 미확정·부분 추출 해소 부족임 |
