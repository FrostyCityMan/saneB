...
| 6 자동·실파일 QA | [!] | 09-22 서울 태백 관측1/1·새 production 고정 비교1/1·정리 성공, 합계8요청/2,658,726bytes·정상0/검수 유지. 후속1a19e63 Linux35629360526 성공(root2488통과/266조건부 생략, 독립PG221/221·정책 부모2). 전체 Provider 정상/형식 기대값·부분 추출·보은 등 접근 실패는 미해소 |
| 7 운영 배포·활성화 | [~] | 마지막09-21 Runtime/DB SSM은787c594·V83·추출기1.0.1·catalog24/기대값1·health UP·첨부 count0/worker 비활성/외부키2종 없음.09-22 임시 QA의 JAR불변/health 확인과 구분. 현재 AWS 재인증 대기이며 새1a19e63/추출기1.0.3 재배포 재개와 게시/ENFORCE/기존 데이터의 정확한 범위 승인은 별도로 필요 |
