...
후속1.0.10까지의 최신 누적은52/60요청·40,644,661/100,663,296byte다. 51022의 표 헤더 오류19회는해소됐으나 미지원record/control 및 PDF 부분 추출은 남는다. [실제 헤더 진단·개선 결과](announcement-hwp-header-diagnostic-v1.0.9-2026-09-25.md)를 따른다. 아래16/29회 원장은 각 선행 단계 당시 값으로 새 실행의 잔여 한도가 아니다.
