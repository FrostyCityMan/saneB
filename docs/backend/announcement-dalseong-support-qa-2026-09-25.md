...
후속1.0.11까지의 최신 누적은57/60요청·44,134,566/100,663,296byte다. 잔여3회이므로 최대6요청 단일 공고 실행을 반복할 수 없다. 51022의 표 헤더 오류19회는 해소됐고 남은 컨트롤은 쪽 번호2/도형1로 식별됐으나 그림 레코드/PDF 부분 추출은 남는다. [1.0.11 실측·예산·정리](announcement-hwp-control-kind-diagnostic-v1.0.11-2026-09-25.md)와 [선행 헤더 개선](announcement-hwp-header-diagnostic-v1.0.9-2026-09-25.md)을 구분한다. 아래 원장은 각 선행 단계 당시 값으로 새 실행의 잔여 한도가 아니다.
