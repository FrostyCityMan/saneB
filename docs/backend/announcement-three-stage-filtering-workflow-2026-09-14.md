...
최신 기관 증분: [옥천군 BBS 본문·첨부 프로필](announcement-okcheon-bbs-profile-2026-09-15.md)까지 추가했다. 전용 본문15기관, 첨부 엔진6/등록 프로필16/추출 형식3이다. 옥천3공고3첨부(HWPX3)의 BODY/다운로드/signature를 확인했다. catalog 참조21/실행 기대값0이며 정상 다중첨부/역할·정책 QA는 미완료다. 태백184816의 과거 역할1.0.1 Linux 관측은 본문431자·HWPX2개 완전 추출 후 UNKNOWN 사유를 보존한 REVIEW_REQUIRED였고 현재 profile/역할 버전의 증거가 아니다. 전체 정상 후보·운영 적용으로 계산하지 않는다. 아래 과거 수량은 각 증분 시점의 기록이다.
