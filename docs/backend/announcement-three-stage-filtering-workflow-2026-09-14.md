...
최신 기관 증분: [제천 BBS 본문·첨부 프로필](announcement-jecheon-bbs-profile-2026-09-15.md)까지 추가했다. 전용 본문13기관, 첨부 엔진6/등록 프로필14/추출 형식3이다. 실제 제천3공고4첨부 signature 통과, 원주6첨부 중5개 통과·1개 형식 불일치 거부다. catalog 참조15/실행 기대값0이며 텍스트/정책 QA는 미완료다. 아래 과거 수량은 각 증분 시점의 기록이다.
