...
최신 기관 증분: [원주 BBS 본문·첨부 프로필](announcement-wonju-bbs-profile-2026-09-15.md)을 추가했다. 전용 본문12기관, 첨부 엔진6/등록 프로필13/추출 형식3이다. 실제 원주 첨부6개 중5개 signature 통과·1개 형식 불일치 거부이며 텍스트/정책 QA는 미완료다. 아래 과거 수량은 각 증분 시점의 기록이다.
