...
INSERT INTO announcement_document_requirements (
    ...
    ('40000000-0000-0000-0000-000000000010', 'BUSINESS_REGISTRATION', true, 1),
    ('40000000-0000-0000-0000-000000000010', 'VAT_TAX_BASE', true, 2),
    ('40000000-0000-0000-0000-000000000011', 'BUSINESS_REGISTRATION', true, 1),
    ('40000000-0000-0000-0000-000000000012', 'FAMILY_RELATION', true, 1),
    ('40000000-0000-0000-0000-000000000013', 'BUSINESS_REGISTRATION', true, 1),
    ('40000000-0000-0000-0000-000000000014', 'BUSINESS_REGISTRATION', true, 1)
...
INSERT INTO announcement_input_requirements (
    ...
    ('42000000-0000-0000-0000-000000000010', '40000000-0000-0000-0000-000000000010', 'ANNUAL_REVENUE', '연매출', 'AMOUNT', 'BUSINESS', true, true, 10, '부가세 과세표준 또는 면세사업자 수입금액 기준으로 입력합니다.'),
    ('42000000-0000-0000-0000-000000000011', '40000000-0000-0000-0000-000000000010', 'BUSINESS_YEARS', '업력', 'NUMBER', 'BUSINESS', true, false, 20, '사업자등록증의 개업일 기준으로 계산한 연수를 입력합니다.'),
    ('42000000-0000-0000-0000-000000000012', '40000000-0000-0000-0000-000000000011', 'WORKPLACE_REGION_CODE', '사업장 지역', 'SELECT', 'BUSINESS', true, false, 10, '사업자등록증 또는 임대차계약서의 사업장 소재지를 선택합니다.'),
    ('42000000-0000-0000-0000-000000000013', '40000000-0000-0000-0000-000000000012', 'HAS_CHILD', '자녀 여부', 'RADIO', 'CHILD', true, false, 10, '가족관계증명서 기준으로 자녀 여부를 선택합니다.'),
    ('42000000-0000-0000-0000-000000000014', '40000000-0000-0000-0000-000000000013', 'HAS_POLICY_FUND_USAGE', '정책자금 이용 이력', 'RADIO', 'BUSINESS', true, false, 10, '최근 동일·유사 정책자금 이용 여부를 선택합니다.'),
    ('42000000-0000-0000-0000-000000000015', '40000000-0000-0000-0000-000000000013', 'HAS_GUARANTEE_USAGE', '보증 이용 이력', 'RADIO', 'BUSINESS', true, false, 20, '보증기관 보증 이용 여부를 선택합니다.')
