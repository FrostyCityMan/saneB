...
class StandardBbsBodyContentLiveQaTest {
    ...
    static Stream<Sample> selectBoeunCases() {
        return Stream.of(new Sample("www.boeun.go.kr", "66", "194", "221499"),
                new Sample("www.boeun.go.kr", "66", "194", "221497"), new Sample("www.boeun.go.kr", "66", "194", "218812"));
    }
    @ParameterizedTest(name = "보은 본문 표본 {index}") @MethodSource("selectBoeunCases") @Timeout(30)
    void readsBoeunBodyWithoutRequestingFiles(Sample site) {
        readsMeasuredOfficialBodyWithoutRequestingFiles(site);
    }
    static Stream<Sample> selectOkcheonCases() {
        return Stream.of(new Sample("www.oc.go.kr", "40", "236", "193369"),
                new Sample("www.oc.go.kr", "40", "236", "193297"), new Sample("www.oc.go.kr", "40", "236", "193187"));
    }
    @ParameterizedTest(name = "옥천 본문 표본 {index}") @MethodSource("selectOkcheonCases") @Timeout(30)
    ...
    static Stream<Sample> selectCheorwonCases() {
        return Stream.of(new Sample("www.cwg.go.kr", "25", "1226", "288915"),
                new Sample("www.cwg.go.kr", "25", "1226", "291529"), new Sample("www.cwg.go.kr", "25", "1226", "291245"));
    }
    @ParameterizedTest(name = "철원 본문 표본 {index}") @MethodSource("selectCheorwonCases") @Timeout(30)
    void readsCheorwonBodyWithoutRequestingFiles(Sample site) {
        readsMeasuredOfficialBodyWithoutRequestingFiles(site);
    }
